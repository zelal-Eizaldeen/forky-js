...
Object.defineProperty(exports, "escapeMarkdown", {
  enumerable: true,
  get: function () {
    return _escapeMarkdown().escapeMarkdown;
  }
});
...
function _promisify() {
  const data = _interopRequireDefault(require("./promisify"));
...
function _escapeMarkdown() {
  const data = require("./escape-markdown");

  _escapeMarkdown = function () {
    return data;
  };
