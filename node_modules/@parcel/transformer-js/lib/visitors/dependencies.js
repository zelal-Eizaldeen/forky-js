...
var _default = {
  ...
  NewExpression: {
    exit(node, {
      ...
      let isWebWorker = callee.type === 'Identifier' && (callee.name === 'Worker' || callee.name === 'SharedWorker') && !(0, _utils2().hasBinding)(ancestors, callee.name) && !(0, _utils2().isInFalsyBranch)(ancestors) && (args.length === 1 || args.length === 2);
