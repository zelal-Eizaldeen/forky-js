...
var _default = new (_plugin().Transformer)({
  async loadConfig({
    ...
    if (configFile && configResult.contents.includePaths) {
      configResult.contents.includePaths = configResult.contents.includePaths.map(p => _path().default.resolve(_path().default.dirname(configFile.filePath), p));
    }
  ...
  async transform({
    ...
    let sassRender = (0, _utils().promisify)(_sass().default.render.bind(_sass().default));
    let css;
